...
{
    public class GameAIModule : GameModuleBaseInstance<GameAIModule>
    {
        /// <summary>
        /// 构造函数中调用，托管对象可以在这初始化
        /// </summary>
        ...
        {
            RegisterHandler<GameAIClientHandler>();
            RegisterHandler<GameAIDataHandler>();
            RegisterHandler<GameAIViewHandler>();
        }
        /// <summary>
        /// 当所有游戏模块刚被构建的时候回传触发
        /// </summary>
