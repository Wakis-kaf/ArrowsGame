...
namespace Framework.Runtime
{
    ...
    public class DownloadFileMac
    {
        ...
        private const int Md5ReadLen = 16 * 1024;
        ...
        public bool Download()
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.ErrorAsync("下载出错：" + ex.Message);
        ...
        private bool CheckMd5()
        {
            ...
            {
                File.Delete(_downUnit.savePath);
                Log.DebugAsync("文件MD5校验出错：" + _downUnit.name);
                _state = DownloadMacState.Error;
        ...
        private int GetWebFileSize(string url)
        {
            ...
            {
                Log.ErrorAsync("获取文件长度出错：" + e.Message);
                _state = DownloadMacState.Error;
