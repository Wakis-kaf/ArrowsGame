...
{
    public static class UnitUIEditorTool
    {
        public static SerializedProperty SerializedProperty(SerializedObject serializedObject, string propertyName,string labelName ="")
        {
        ...
        public static void DrawSprite(Sprite sprite, Rect drawArea, Color color)
        {
            ...
            Vector4 uv4 = DataUtility.GetOuterUV(sprite);
        ...
        public static void HideMoveTool(bool hide)
        {
            ...
            Tools.hidden = hide && (Tools.current == Tool.Move);
#endif
        }

        public static bool DrawProperty(string label, SerializedObject serializedObject, string property,
            ...
            bool padding, params GUILayoutOption[] options)
        {
            ...
            if (sp != null)
            {
                ...
                if (label != null)
                {
                    ...
                    if (EditorGUILayout.PropertyField(sp, new GUIContent(label), true, options))
                    {
                ...
                {
                    if (EditorGUILayout.PropertyField(sp, true, options))
                    {
                        EditorUtility.SetDirty(serializedObject.targetObject);
                    }
                }
