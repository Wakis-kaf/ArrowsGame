...
Expert knowledge of Unity testing patterns, EditMode/PlayMode tests, and test-driven development for the ArrowsGame project.
...
using ArrowsGame.Config;

namespace ArrowsGame.Tests.Editor
{
    [TestFixture]
...
using ArrowsGame.View;

namespace ArrowsGame.Tests.Runtime
{
    [TestFixture]
...
{
  "testMode": "EditMode",
  "testMethod": "ArrowsGame.Tests.Editor.LayoutConfigTests.GridSize_ShouldBeFive"
}
```
